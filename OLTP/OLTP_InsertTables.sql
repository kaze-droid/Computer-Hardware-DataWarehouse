...
-- Replace the path with the appropriate path
FROM 'C:\Users\ryany\OneDrive\Desktop\SP Y2S1\DENG\CA2\OLTP\DataSourceInsert\Countries\Countries.csv'
WITH
(
FORMAT = 'CSV',
FIRSTROW = 2,
...
-- Replace the path with the appropriate path
FROM 'C:\Users\ryany\OneDrive\Desktop\SP Y2S1\DENG\CA2\OLTP\DataSourceInsert\Locations\Locations.csv'
WITH
(
FORMAT = 'CSV',
FIRSTROW = 2,
...
-- Replace the path with the appropriate path
FROM 'C:\Users\ryany\OneDrive\Desktop\SP Y2S1\DENG\CA2\OLTP\DataSourceInsert\Warehouses\Warehouses.txt'
WITH
(
FIRSTROW = 2,
FIELDTERMINATOR= '\t',
...
-- Replace the path with the appropriate path
FROM 'C:\Users\ryany\OneDrive\Desktop\SP Y2S1\DENG\CA2\OLTP\DataSourceInsert\Customers\Customers.csv'
WITH
(
FORMAT = 'CSV',
FIRSTROW = 1,
...
-- Replace the path with the appropriate path
FROM 'C:\Users\ryany\OneDrive\Desktop\SP Y2S1\DENG\CA2\OLTP\DataSourceInsert\Contacts\Contacts.csv'
WITH
(
FORMAT = 'CSV',
FIRSTROW = 2,
...
Select @Order =
BulkColumn
from OPENROWSET(BULK 'C:\Users\ryany\OneDrive\Desktop\SP Y2S1\DENG\CA2\OLTP\DataSourceInsert\Order\Order.json', SINGLE_BLOB) JSON
...
-- Replace the path with the appropriate path
FROM 'C:\Users\ryany\OneDrive\Desktop\SP Y2S1\DENG\CA2\OLTP\DataSourceInsert\Product_Categories\Product_Categories.csv'
WITH
(
FORMAT = 'CSV',
FIRSTROW = 2,
...
-- Replace the path with the appropriate path
FROM 'C:\Users\ryany\OneDrive\Desktop\SP Y2S1\DENG\CA2\OLTP\DataSourceInsert\Products\Products.csv'
WITH
(
FORMAT = 'CSV',
FIRSTROW = 2,
...
Select @OrderItems =
BulkColumn
from OPENROWSET(BULK 'C:\Users\ryany\OneDrive\Desktop\SP Y2S1\DENG\CA2\OLTP\DataSourceInsert\Order_Items\Order_items.json', SINGLE_BLOB) JSON
...
-- Replace the path with the appropriate path
FROM 'C:\Users\ryany\OneDrive\Desktop\SP Y2S1\DENG\CA2\OLTP\DataSourceInsert\Inventories\Inventories.csv'
WITH
(
FORMAT = 'CSV',
FIRSTROW = 2,
